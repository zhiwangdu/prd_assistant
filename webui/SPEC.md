...
WebUI 提供本地工具工作台的可视化管理能力。用户应该可以不依赖任何 Agent，直接完成工具配置、运行、结果查看和 MCP 配置复制。
...
- 展示 MCP endpoint、Authorization header 示例、客户端配置示例。
...
- MCP 页面展示的 tools/resources 与 Server 返回一致。
