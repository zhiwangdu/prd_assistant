...
- V2 Tools 页面必须支持独立手动 `tool_run`：用户可填写已有
  ...
  `inputFiles` 复用 Workspace 已知输入；然后调用
  `/api/v2/tools/:tool_id/runs` 创建 run，使用
