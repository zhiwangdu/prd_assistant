...
- 顶部导航能进入 `System Context` 页面；该页是 V2 System Context + Metadata 原生入口，默认直接调用 `/api/v2/skills*`、`/api/v2/system-context/*` 和 `/api/v2/metadata*`，不再默认渲染旧 Rust Skills/Metadata 面板。
