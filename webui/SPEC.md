...
- V2 Tools bridge 必须调用 `/api/v2/tools` 展示 V2 工具目录，展示 enabled、backend、source、runnable、match 和 params schema，并支持通过带 Authorization header 的请求下载 `/api/v2/exports/tools.zip`。
